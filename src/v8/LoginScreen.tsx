...
function Brand() { return <div className="flex items-center gap-3"><div className="grid h-12 w-14 place-items-center overflow-hidden rounded-[14px] border border-[#b9a478]/25 bg-[#b9a478]/8 p-1"><img src="./branch-emblem.svg" alt="شعار فرع اتصالات ريف دمشق" className="h-full w-full object-contain" /></div><div><div className="text-sm font-black">{`فرع اتصالات ريف دمشق`}</div><div className="mt-0.5 text-[9px] font-bold tracking-[.2em] text-cyan-300/60">OPERATIONS COMMAND</div></div></div>; }
